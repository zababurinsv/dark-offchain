...
export const productActivitiesHandler: HandlerFn = (req, res) =>
  activityHandler(req, res, pgQueries.getProductActivitiesData)

export const productActivitiesCountHandler: HandlerFn = (req, res) =>
  countHandler(req, res, pgQueries.getProductActivitiesCount)


export const orderingActivitiesHandler: HandlerFn = (req, res) =>
  activityHandler(req, res, pgQueries.getOrderingActivitiesData)

export const orderingActivitiesCountHandler: HandlerFn = (req, res) =>
  countHandler(req, res, pgQueries.getOrderingActivitiesCount)
...
export const storefrontActivitiesHandler: HandlerFn = (req, res) =>
  activityHandler(req, res, pgQueries.getStorefrontActivitiesData)

export const storefrontActivitiesCountHandler: HandlerFn = (req, res) =>
  countHandler(req, res, pgQueries.getStorefrontActivitiesCount)
