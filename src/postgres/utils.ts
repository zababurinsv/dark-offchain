...
export type action = 'StorefrontCreated' | 'StorefrontUpdated' | 'StorefrontFollowed' | 'StorefrontUnfollowed' | 'AccountFollowed' | 'AccountUnfollowed' | 'ProductCreated' | 'ProductUpdated' | 'ProductShared' | 'OrderingCreated' | 'OrderingUpdated' | 'CommentCreated' | 'CommentUpdated' | 'CommentShared' | 'CommentDeleted' | 'CommentReplyCreated' | 'ProductReactionCreated' | 'ProductReactionUpdated' | 'CommentReactionCreated' | 'CommentReactionUpdated';
